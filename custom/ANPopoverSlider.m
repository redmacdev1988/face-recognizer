...
-(void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    [_delegate updateSliderValue:_popupView.value];
    
    //don't fade out the popover
...
-(void)positionAndUpdatePopupView {
    ...
    //DLOG(@"positionAndUpdatePopupView");
...
{
    if([_delegate respondsToSelector:@selector(updateSliderValue:)])
    {
        [_delegate updateSliderValue:value];
    }
}
